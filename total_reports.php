...
<body>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <input class="form-control" type="text" id="datestart" name="datestart" autocomplete="off">
                                </div>
                                <div class="col-lg-4">
                                    <label for="dateend">تاریخ پایان :</label>
                                    <input class="form-control" type="text" id="dateend" name="dateend" autocomplete="off">
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="users_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $lang['LBL_TOTAL_QTY']; ?></th>
                                                <th><?php echo $lang['LBL_TOTAL_PRICE']; ?></th>
                                    ...
                                    <div class="panel panel-info">
                                        <div class="panel-body">
                                            <div class="col-lg-3">
                                                <input type="hidden" value="0" id="Sale_Qty_Hidden">
                                                <b>فروش - تعداد</b> : <label id="Sale_Qty_Lable"></label>
                                            </div>
                                            <div class="col-lg-3">
                                                <input type="hidden" value="0" id="Sale_Price_Hidden">
                                                <b>فروش - مبلغ</b> : <label id="Sale_Price_Lable"></label>
                                            </div>
                                            <div class="col-lg-3">
                                                <input type="hidden" value="0" id="Ref_Qty_Hidden">
                                                <b>مرجوعی - تعداد</b> : <label id="Ref_Qty_Lable"></label>
                                            </div>
                                            <div class="col-lg-3">
                                                <input type="hidden" value="0" id="Ref_Price_Hidden">
                                                <b>مرجوعی - مبلغ</b> : <label id="Ref_Price_Lable"></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-success">
                                        <div class="panel-body">
                                            <div class="col-lg-6">
                                                <input type="hidden" value="0" id="Grand_Sale_Qty_Hidden">
                                                <b>فروش - تعداد (خالص)</b> : <label id="Grand_Sale_Qty_Lable"></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="hidden" value="0" id="Grand_Sale_Price_Hidden">
                                                <b>فروش - مبلغ (خالص)</b> : <label id="Grand_Sale_Price_Lable"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="vendor/js/total_reports_v4.js"></script>
    <script>
