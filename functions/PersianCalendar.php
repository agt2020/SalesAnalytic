...
function mds_to_gregorian($m_y, $j_m, $m_d)
{
   ...
   return array($gy, $gm, $gd, $leap);
}
//Change by dipak
function get_no_days_of_month($Dmonth, $Dday, $Dyear)
{
	$year="";
	$month="";
	$year="";
	...
	list( $year, $month, $day ) = mds_to_gregorian($Dyear, $Dmonth, "1");
	$result = lastday($month,$day,$year);
	//echo $Dyear.' => '.$Dmonth.' => '.$result.'<br/>';
                
        //$diffDays =$result - $Dday;
